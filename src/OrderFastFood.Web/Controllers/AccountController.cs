...
using OrderFastFood.Sessions;
using OrderFastFood.Web.Controllers.Results;
using OrderFastFood.Web.Models;
using OrderFastFood.Web.Models.Account;
...
{
    public class AccountController : OrderFastFoodControllerBase
    {
