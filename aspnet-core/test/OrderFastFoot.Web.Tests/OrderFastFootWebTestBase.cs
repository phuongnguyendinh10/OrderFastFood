...
{
    public abstract class OrderFastFootWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OrderFastFootWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OrderFastFootWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OrderFastFootDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OrderFastFootDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OrderFastFootDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OrderFastFootDbContext, Task<T>> func)
        {
            T result;
